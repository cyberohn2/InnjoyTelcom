            ...
            <div className="pt-[75px] pb-[15px]  text-white max-w-[1440px] mx-auto">
                <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start gap-8">
                    ...
                    <div className="flex gap-6 items-center">
                        ...
                        <svg fill="#ffffff" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 24 24" style={{enableBackground: "new 0 0 24 24"}} xml:space="preserve" width="20" height="17">
                        <g id="XMLID_184_">
